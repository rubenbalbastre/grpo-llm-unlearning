...
def get_available_cpu_cores():
    # On Linux, this respects CPU affinity / SLURM cpus-per-task limits
    if hasattr(os, "sched_getaffinity"):
        return len(os.sched_getaffinity(0))

    # Fallback: total logical CPUs visible to Python
    return os.cpu_count()
...
def main():
    ...
    if torch.cuda.is_available():
        ...
        print("Hello, world! PyTorch is working on CPU!")
        print("x:", x)
        print("y:", y)
        print("x + y:", z)
